    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stduncertainty', models.CharField(blank=True, max_length=64, null=True)),
                ('relstduncertainty', models.CharField(blank=True, max_length=64, null=True)),
                ('version', models.CharField(blank=True, max_length=32, null=True)),
                ('symbol', models.CharField(blank=True, max_length=16, null=True)),
                ('concise_html', models.CharField(blank=True, max_length=256, null=True)),
                ('concise_text', models.CharField(blank=True, max_length=256, null=True)),
                ('mantissa', models.CharField(blank=True, max_length=32, null=True)),
                ('exponent', models.IntegerField(blank=True, null=True)),
                ('sigfigs', models.IntegerField(blank=True, null=True)),
                ...
                ('validfrom', models.CharField(blank=True, max_length=64, null=True)),
                ('unitstr', models.CharField(blank=True, max_length=32, null=True)),
                ('unitstrsi', models.CharField(blank=True, max_length=32, null=True)),
